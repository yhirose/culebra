...
SECTIONS_PY_SCALAR = [
    ...
    ('Vocabulary (sorted unique chars)',      (26, 30),   (24, 34)),
    ('class Value — fields &amp; special methods', (32, 60),   (36, 95)),
    ('Value.backward — topo + grad walk',     (62, 75),   (96, 123)),
    ('sum_v / max_data (Culebra helpers; Python uses sum() / max() builtins)',
                                              None,       (125, 131)),
    ('Hyperparameters',                       (77, 82),   (133, 139)),
    ('matrix factory',                        (83, 83),   (141, 143)),
    ('state / params collection',             (84, 93),   (145, 176)),
    ('linear (with dot helper)',              (95, 98),   (178, 182)),
    ('softmax',                               (100, 104), (184, 189)),
    ('rmsnorm',                               (106, 109), (191, 195)),
    ('add_v (element-wise vector add)',       None,       (197, 197)),
    ('gpt — forward pass (model)',            (111, 147), (199, 240)),
    ('Adam state init',                       (149, 152), (242, 252)),
    ('Training loop',                         (154, 188), (254, 309)),
    ('Final loss + inference',                (190, 207), (311, 341)),
]
