...
SECTIONS_PY_SCALAR = [
    ...
    ('Value.backward — topo + grad walk',     (62, 75),   (70, 88)),
    ('sum_v / max_data (Culebra helpers; Python uses sum() / max() builtins)',
                                              None,       (90, 94)),
    ('Hyperparameters',                       (77, 82),   (97, 103)),
    ('matrix factory',                        (83, 83),   (105, 108)),
    ('state / params collection',             (84, 93),   (110, 142)),
    ('linear (with dot helper)',              (95, 98),   (145, 150)),
    ('softmax',                               (100, 104), (152, 157)),
    ('rmsnorm',                               (106, 109), (159, 163)),
    ('add_v (element-wise vector add)',       None,       (165, 165)),
    ('gpt — forward pass (model)',            (111, 147), (167, 206)),
