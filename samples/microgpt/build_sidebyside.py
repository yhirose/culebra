...
SECTIONS_SCALAR_TENSOR = [
    ...
    ('Hyperparameters (tensor places them before the autograd class)',
                                                                (99, 105),  (43, 51)),
    ('Autograd class — Value (per-scalar dunders + backward) vs TNode (Tensor wrapper, no dunders)',
                                                                (33, 90),   (53, 83)),
    ('sum_v / max_data (scalar helpers; Tensor uses Tensor.sum / .argmax)',
                                                                (92, 96),   None),
    ('Op factories: arithmetic + dot + sum_to_scalar + embed (Tensor only — scalar uses Value dunders)',
                                                                None,       (85, 168)),
