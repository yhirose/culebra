...
// archive also bundles the amalgamation object (src/runtime/culebra_sqlite3.c,
// added in CMake), so a force-loaded culebra_rt_sqlite is fully self-contained and a
