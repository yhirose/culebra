...
#
# Usage: misc/windows_toolchain/configure_windows_release.sh <build dir> [extra cmake args…]
#
...
# tools/checks/check_release_covered_by_ci.sh sees this script in both workflows.
#
# The Canvas window is deliberately NOT spelled here. CMake defaults it ON, and
# both callers assert that with misc/aot_axes/verify_canvas_window.sh — passing the
