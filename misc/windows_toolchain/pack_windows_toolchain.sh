...
#
# Usage: misc/windows_toolchain/pack_windows_toolchain.sh <out dir> <version> <culebra.exe>
...
recipe="$kit/link-recipe.txt"
{
  ...
  echo "# Generated by misc/windows_toolchain/pack_windows_toolchain.sh — do not edit."
  echo "TARGET $target"
} > "$recipe"
