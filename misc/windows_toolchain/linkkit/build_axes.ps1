...
# installed, checking each program's output against misc/windows_toolchain/linkkit/expected.tsv.
#
# Usage: pwsh misc/windows_toolchain/linkkit/build_axes.ps1 <culebra.exe>
#
