...
gen() {
  ...
  printf '#pragma once\n\n'
  for base in time term canvas args matchers regex peg fst search string_fns log desktop path vector2 vector3 deque priority_queue state_machine effects test_ambient; do
