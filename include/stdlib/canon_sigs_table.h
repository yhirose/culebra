...
inline constexpr CanonParam kCanonParams_Search[] = {
  // 0: Search.Index.new
  {"analyzer", true, false, false, false, false, "Object", CanonDefault::Nil, 0, {}},
  // 1: Search.Index.load
  {"path", false, false, false, false, false, "String", CanonDefault::None, 0, {}},
  {"analyzer", true, false, false, false, false, "Object", CanonDefault::Nil, 0, {}},
  {"readonly", true, false, false, false, false, "", CanonDefault::Bool, 0, {}},
  // 4: Search.segmenter
  {"model", false, false, false, false, false, "String", CanonDefault::None, 0, {}},
};

inline constexpr CanonSig kCanonSigs_Search[] = {
  {"Search", "Index", "new", kCanonParams_Search + 0, 1, "Object", 0, 1, false, -1, -1, -1},
  {"Search", "Index", "load", kCanonParams_Search + 1, 3, "Object", 1, 3, false, -1, -1, -1},
  {"Search", "", "segmenter", kCanonParams_Search + 4, 1, "Object", 1, 1, false, -1, -1, -1},
};
...
inline constexpr CanonSig kCanonObjectSigs[] = {
  {"", "", "empty", nullptr, 0, "Bool", 0, 0, false, -1, -1, -1},
  {"", "", "get", kCanonParamPool + 0, 2, "Any", 2, 2, false, -1, -1, -1},
  {"", "", "get_or_put", kCanonParamPool + 2, 2, "Any", 2, 2, false, -1, -1, -1},
  {"", "", "has", kCanonParamPool + 4, 1, "Bool", 1, 1, false, -1, -1, -1},
  {"", "", "iter", nullptr, 0, "", 0, 0, false, -1, -1, -1},
  {"", "", "keys", nullptr, 0, "Array", 0, 0, false, -1, -1, -1},
  {"", "", "presence", nullptr, 0, "Object | Nil", 0, 0, false, -1, -1, -1},
  {"", "", "remove", kCanonParamPool + 5, 1, "Nil", 1, 1, false, -1, -1, -1},
  {"", "", "size", nullptr, 0, "Long", 0, 0, false, -1, -1, -1},
  {"", "", "values", nullptr, 0, "Iterator", 0, 0, false, -1, -1, -1},
};

inline constexpr CanonSig kCanonArraySigs[] = {
  {"", "", "all", kCanonParamPool + 6, 1, "Bool", 1, 1, false, -1, -1, -1},
  {"", "", "any", kCanonParamPool + 7, 1, "Bool", 1, 1, false, -1, -1, -1},
  {"", "", "contains", kCanonParamPool + 8, 1, "Bool", 1, 1, false, -1, -1, -1},
  {"", "", "empty", nullptr, 0, "Bool", 0, 0, false, -1, -1, -1},
  {"", "", "enumerate", nullptr, 0, "", 0, 0, false, -1, -1, -1},
  {"", "", "extend", kCanonParamPool + 9, 1, "Nil", 1, 1, false, -1, -1, -1},
  {"", "", "filter", kCanonParamPool + 10, 1, "Array", 1, 1, false, -1, -1, -1},
  {"", "", "find", kCanonParamPool + 11, 1, "Any", 1, 1, false, -1, -1, -1},
  {"", "", "flat_map", kCanonParamPool + 12, 1, "Array", 1, 1, false, -1, -1, -1},
  {"", "", "for_each", kCanonParamPool + 13, 1, "Nil", 1, 1, false, -1, -1, -1},
  {"", "", "get", kCanonParamPool + 14, 2, "Any", 2, 2, false, -1, -1, -1},
  {"", "", "group_by", kCanonParamPool + 16, 1, "Object", 1, 1, false, -1, -1, -1},
  {"", "", "index_of", kCanonParamPool + 17, 1, "Long", 1, 1, false, -1, -1, -1},
  {"", "", "insert", kCanonParamPool + 18, 2, "Nil", 2, 2, false, -1, -1, -1},
  {"", "", "iter", nullptr, 0, "", 0, 0, false, -1, -1, -1},
  {"", "", "join", kCanonParamPool + 20, 1, "String", 1, 1, false, -1, -1, -1},
  {"", "", "map", kCanonParamPool + 21, 1, "Array", 1, 1, false, -1, -1, -1},
  {"", "", "max", nullptr, 0, "Any", 0, 0, false, -1, -1, -1},
  {"", "", "max_by", kCanonParamPool + 22, 1, "Any", 1, 1, false, -1, -1, -1},
  {"", "", "min", nullptr, 0, "Any", 0, 0, false, -1, -1, -1},
  {"", "", "min_by", kCanonParamPool + 23, 1, "Any", 1, 1, false, -1, -1, -1},
  {"", "", "partition", kCanonParamPool + 24, 1, "Tuple", 1, 1, false, -1, -1, -1},
  {"", "", "pop", nullptr, 0, "Any", 0, 0, false, -1, -1, -1},
  {"", "", "presence", nullptr, 0, "Array | Nil", 0, 0, false, -1, -1, -1},
  {"", "", "product", nullptr, 0, "Long | Float", 0, 0, false, -1, -1, -1},
  {"", "", "push", kCanonParamPool + 25, 1, "Nil", 1, 1, false, -1, -1, -1},
  {"", "", "reduce", kCanonParamPool + 26, 2, "Any", 2, 2, false, -1, -1, -1},
  {"", "", "remove_at", kCanonParamPool + 28, 1, "Any", 1, 1, false, -1, -1, -1},
  {"", "", "reverse", nullptr, 0, "Nil", 0, 0, false, -1, -1, -1},
  {"", "", "size", nullptr, 0, "Long", 0, 0, false, -1, -1, -1},
  {"", "", "slice", kCanonParamPool + 29, 2, "Array", 2, 2, false, -1, -1, -1},
  {"", "", "sort", kCanonParamPool + 31, 1, "Nil", 0, 0, false, -1, 0, -1},
  {"", "", "sort_by", kCanonParamPool + 32, 2, "Nil", 1, 1, false, -1, 1, -1},
  {"", "", "sorted", kCanonParamPool + 34, 1, "Array", 0, 0, false, -1, 0, -1},
  {"", "", "sorted_by", kCanonParamPool + 35, 2, "Array", 1, 1, false, -1, 1, -1},
  {"", "", "sum", nullptr, 0, "Long | Float", 0, 0, false, -1, -1, -1},
  {"", "", "to_object", nullptr, 0, "Object", 0, 0, false, -1, -1, -1},
  {"", "", "to_set", nullptr, 0, "Set", 0, 0, false, -1, -1, -1},
  {"", "", "unzip", nullptr, 0, "Tuple", 0, 0, false, -1, -1, -1},
};

inline constexpr CanonSig kCanonStringSigs[] = {
  {"", "", "bytes", nullptr, 0, "Iterator<Long>", 0, 0, false, -1, -1, -1},
  {"", "", "capitalize", nullptr, 0, "String", 0, 0, false, -1, -1, -1},
  {"", "", "code_points", nullptr, 0, "Iterator<Long>", 0, 0, false, -1, -1, -1},
  {"", "", "contains", kCanonParamPool + 37, 1, "Bool", 1, 1, false, -1, -1, -1},
  {"", "", "count", kCanonParamPool + 38, 1, "Long", 1, 1, false, -1, -1, -1},
  {"", "", "empty", nullptr, 0, "Bool", 0, 0, false, -1, -1, -1},
  {"", "", "ends_with", kCanonParamPool + 39, 1, "Bool", 1, 1, false, -1, -1, -1},
  {"", "", "eq_ignore_case", kCanonParamPool + 40, 1, "Bool", 1, 1, false, -1, -1, -1},
  {"", "", "graphemes", nullptr, 0, "Iterator<StringView>", 0, 0, false, -1, -1, -1},
  {"", "", "index_of", kCanonParamPool + 41, 2, "Long", 1, 2, false, -1, -1, -1},
  {"", "", "is_alnum", nullptr, 0, "Bool", 0, 0, false, -1, -1, -1},
  {"", "", "is_alpha", nullptr, 0, "Bool", 0, 0, false, -1, -1, -1},
  {"", "", "is_ascii", nullptr, 0, "Bool", 0, 0, false, -1, -1, -1},
  {"", "", "is_digit", nullptr, 0, "Bool", 0, 0, false, -1, -1, -1},
  {"", "", "is_space", nullptr, 0, "Bool", 0, 0, false, -1, -1, -1},
  {"", "", "iter", nullptr, 0, "Iterator<StringView>", 0, 0, false, -1, -1, -1},
  {"", "", "last_index_of", kCanonParamPool + 43, 1, "Long", 1, 1, false, -1, -1, -1},
  {"", "", "lines", nullptr, 0, "Array<StringView>", 0, 0, false, -1, -1, -1},
  {"", "", "lower", nullptr, 0, "String", 0, 0, false, -1, -1, -1},
  {"", "", "normalize", kCanonParamPool + 44, 1, "String", 0, 1, false, -1, -1, -1},
  {"", "", "presence", nullptr, 0, "String | StringView | Nil", 0, 0, false, -1, -1, -1},
  {"", "", "repeat", kCanonParamPool + 45, 1, "String", 1, 1, false, -1, -1, -1},
  {"", "", "reverse", nullptr, 0, "String", 0, 0, false, -1, -1, -1},
  {"", "", "rsplit", kCanonParamPool + 46, 2, "Array<StringView>", 1, 2, false, -1, -1, -1},
  {"", "", "sentences", nullptr, 0, "Iterator<StringView>", 0, 0, false, -1, -1, -1},
  {"", "", "size", nullptr, 0, "Long", 0, 0, false, -1, -1, -1},
  {"", "", "slice", kCanonParamPool + 48, 2, "StringView", 2, 2, false, -1, -1, -1},
  {"", "", "split", kCanonParamPool + 50, 2, "Array<StringView>", 1, 2, false, -1, -1, -1},
  {"", "", "split_iter", kCanonParamPool + 52, 1, "Iterator<StringView>", 1, 1, false, -1, -1, -1},
  {"", "", "split_whitespace", nullptr, 0, "Array<StringView>", 0, 0, false, -1, -1, -1},
  {"", "", "starts_with", kCanonParamPool + 53, 1, "Bool", 1, 1, false, -1, -1, -1},
  {"", "", "strip_prefix", kCanonParamPool + 54, 1, "String", 1, 1, false, -1, -1, -1},
  {"", "", "strip_suffix", kCanonParamPool + 55, 1, "String", 1, 1, false, -1, -1, -1},
  {"", "", "title", nullptr, 0, "String", 0, 0, false, -1, -1, -1},
  {"", "", "to_string", nullptr, 0, "String", 0, 0, false, -1, -1, -1},
  {"", "", "tr", kCanonParamPool + 56, 2, "String", 2, 2, false, -1, -1, -1},
  {"", "", "trim", nullptr, 0, "String", 0, 0, false, -1, -1, -1},
  {"", "", "trim_end", kCanonParamPool + 58, 1, "String", 0, 1, false, -1, -1, -1},
  {"", "", "trim_start", kCanonParamPool + 59, 1, "String", 0, 1, false, -1, -1, -1},
  {"", "", "truncate", kCanonParamPool + 60, 2, "String", 1, 2, false, -1, -1, -1},
  {"", "", "upper", nullptr, 0, "String", 0, 0, false, -1, -1, -1},
  {"", "", "view", nullptr, 0, "StringView", 0, 0, false, -1, -1, -1},
  {"", "", "words", nullptr, 0, "Iterator<Tuple>", 0, 0, false, -1, -1, -1},
};
...
inline constexpr CanonSig kCanonTensorSigs[] = {
  ...
  {"", "", "ge", kCanonParamPool + 121, 1, "Tensor", 1, 1, false, -1, -1, -1},
  ...
  {"", "", "rope", kCanonParamPool + 128, 2, "Tensor", 2, 2, false, -1, -1, -1},
