...
#include <base/os_compat.h>  // guarded <windows.h> (NOMINMAX + WIN32_LEAN_AND_MEAN)
#endif

#include <base/shared.h>  // culebra_g_sigint / interrupt_requested / throw_if_interrupted
