...
#include <stdlib/canon_sigs.h>   // CanonSig / the per-receiver signature tables
#include <rt/rt.h>           // the TAG_* receiver tags (rt_value.inc.h)
#include <frontend/parser.h>       // ArgScan, scan_arg_list
#include <base/shared.h>       // the arity / kwargs error message builders
