#pragma once
// GENERATED by tools/gen_canon_sigs.cc (`just gen-canon-sigs`). Do not edit.
// Canonical native/built-in signature data — see canon_sigs.h for the
// structs and lookup helpers, and `just check-canon-sigs` for the sync gate.
// clang-format off
