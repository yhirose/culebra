...
#include <stdlib_kernels.h>  // the engine-neutral native kernels (B7-b)
...
}  // namespace culebra (the preamble machinery header opens its own)
#include <stdlib_preamble.h>  // the lazy-stdlib preamble machinery (B7-b)
namespace culebra {
