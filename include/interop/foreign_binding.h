...
#include <interop/foreign_fixture.h>
...
inline bool register_foreign_fixture() {
  ...
  wrap<Counter>("__Foreign", "Counter")
      ...
      .method<&Counter::merge>("merge", {"o"})
      .method<&Counter::steal>("steal", {"o"})
      .method<&Counter::add_maybe>("add_maybe", {{"o", nullptr}})
  ...
  wrap<Box>("__Foreign", "Box")
      ...
      .method<&Box::poke>("poke", {"other"})
      .method<&Box::peek_at>("peek_at", {"other"})
