...
#include <base/packable.h>       // shared_buffer_drop
#include <conc/send_node.h>      // SendNode
#include <base/shared.h>         // SizedThread, the cancel/wake flags
#include <conc/sharedval_core.h> // shared_val_drop
