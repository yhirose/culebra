...
#include <fswatcher.h>
#include <script_teardown.h>  // ScriptTeardownGuard (was defined here; B7-b)
#include <parser.h>
...
// (The multimethod dispatch scoring/pick and the slice-bounds rule
// moved to shared.h in Phase 4 B7-b: they are engine-neutral and the
// compiled lanes read them without this header now.)
