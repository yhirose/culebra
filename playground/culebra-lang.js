...
//
// The KEYWORDS/CONSTANTS/BUILTINS block below is generated by `just sync-grammar`
// from misc/keyword-map.txt (the same source the Vim/VSCode/tree-sitter grammars
...
export const culebraLanguage = StreamLanguage.define({
  ...
  tokenTable: {
    ...
    builtinName: t.standard(t.typeName),
    typeName: t.typeName,
...
export const culebraHighlightStyle = HighlightStyle.define([
  ...
  { tag: t.standard(t.typeName), color: "var(--brand)" },
  { tag: t.typeName, color: "var(--text)" },
